...
public final class math_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\tSo as you can see there isn't a ton up here right now; I haven't been doing much outside of code\r\n");
      out.write("\t\t\t\t\tas of recent, so I haven't exactly had a ton of time to do much with math.  However I decided to try\r\n");
      out.write("\t\t\t\t\tto combine the two, and the result is this section of my site.  As of now it's just one page about\r\n");
      out.write("\t\t\t\t\tthe prime numbers this application generates, but I plan on adding at least some of my old college proofs\r\n");
      out.write("\t\t\t\t\tup here soon.\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\tAnyways I have this section because as you may have seen somewhere else on this site I was a Math major at \r\n");
      out.write("\t\t\t\t\tBoston College.  I did a lot of abstract pseudo-graduate math when I was there (Algebra, Analysis),\r\n");
      out.write("\t\t\t\t\tas well as a handful of classes dealing with more applied mathematics.  \r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\tThis may not be particularly exciting for the majority of you, but if you like numbers like I do,\r\n");
      out.write("\t\t\t\t\tplease look around.\r\n");
      out.write("\t\t\t\t</p>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
